...
ALTER TABLE interface_details ADD link_speed BIGINT;
ALTER TABLE interface_details ADD pci_slot TEXT;
...
ALTER TABLE process_open_sockets ADD state TEXT;
...
ALTER TABLE processes ADD is_elevated_token INTEGER;
ALTER TABLE processes ADD elapsed_time BIGINT;
ALTER TABLE processes ADD handle_count BIGINT;
ALTER TABLE processes ADD percent_processor_time BIGINT;
