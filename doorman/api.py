...
from doorman.extensions import log_splitter
...
def logger(node=None):
    ...
    if log_type == 'status':
        log_splitter.handle_status(data, host_identifier=node.host_identifier)
        ...
        log_splitter.handle_result(data, host_identifier=node.host_identifier)
